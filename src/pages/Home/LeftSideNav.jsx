...
const LeftSideNav = () => {
  ...
  return (
    <div className="space-y-2 p-1 ">
      ...
      <div className="py-20 mx-auto  dark:text-gray-800">
          ...
          <div className="mx-auto ">
            <div className="flex w-full mb-8 ">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-violet-600 dark:text-gray-50">
                ...
                <p className="leading-relaxed">
                  Pricing about rent and sale property chose which one need.
                </p>
                <ul className="flex-1 space-y-2">
                  ...
                  <li className="flex items-center space-x-2">
                    ...
                    <span>Adjust prices as needed.</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Stage home for showings.</span>
                  </li>
                  <li className="flex items-center space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Ensure smooth closing process</span>
                  </li>
                </ul>
                <a
            ...
            <div className="flex w-full mb-8 ">
              <div className="flex flex-grow flex-col p-6 space-y-6 rounded shadow sm:p-8 dark:bg-gray-50">
                <div className="space-y-2">
                  <h4 className="text-2xl text-center font-bold">Team</h4>
                  <span className="text-6xl font-bold">
                    $350
                    <span className="text-sm tracking-wide">/month</span>
                  </span>
                ...
                <ul className="space-y-2 dark:text-gray-600">
                  <li className="flex items-start space-x-2">
                    ...
                    <span>Consider buyer preferences carefully</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Determine fair market value</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Analyze local housing market</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Highlight property's unique features</span>
                  </li>
                  <li className="flex items-start space-x-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span>Screen potential tenants thoroughly</span>
                  </li>
                </ul>
                <a
                  rel="noopener noreferrer"
